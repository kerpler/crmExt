...
%>
<link rel=stylesheet
	href="${PATH}/plugins/static/css/gantt/platform.css" type="text/css">
<link rel=stylesheet
	href="${PATH}/plugins/static/js/gantt/libs/jquery/dateField/jquery.dateField.css"
	type="text/css">

<link rel=stylesheet href="${PATH}/plugins/static/css/gantt/gantt.css"
	type="text/css">
<link rel=stylesheet
	href="${PATH}/plugins/static/css/gantt/ganttPrint.css" type="text/css"
	media="print">
<link rel="stylesheet" type="text/css"
	href="${PATH}/plugins/static/css/bootstrap.min.css" />

<script src="${PATH}/plugins/static/js/gantt/jquery.min.js"></script>
<script src="${PATH}/plugins/static/js/gantt/jquery-ui.min.js"></script>

<script
	src="${PATH}/plugins/static/js/gantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
<script
	src="${PATH}/plugins/static/js/gantt/libs/jquery/jquery.timers.js"></script>

<script src="${PATH}/plugins/static/js/gantt/libs/utilities.js"></script>
<script src="${PATH}/plugins/static/js/gantt/libs/forms.js"></script>
<script src="${PATH}/plugins/static/js/gantt/libs/date.js"></script>
<script src="${PATH}/plugins/static/js/gantt/libs/dialogs.js"></script>
<script src="${PATH}/plugins/static/js/gantt/libs/layout.js"></script>
<script src="${PATH}/plugins/static/js/gantt/libs/i18nJs.js"></script>
<script
	src="${PATH}/plugins/static/js/gantt/libs/jquery/dateField/jquery.dateField.js"></script>
<script
	src="${PATH}/plugins/static/js/gantt/libs/jquery/JST/jquery.JST.js"></script>

<script type="text/javascript"
	src="${PATH}/plugins/static/js/gantt/libs/jquery/svg/jquery.svg.min.js"></script>
<script type="text/javascript"
	src="${PATH}/plugins/static/js/gantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>

<script src="${PATH}/plugins/static/js/gantt/ganttUtilities.js"></script>
<script src="${PATH}/plugins/static/js/gantt/ganttTask.js"></script>
<script src="${PATH}/plugins/static/js/gantt/ganttDrawerSVG.js"></script>
<script src="${PATH}/plugins/static/js/gantt/ganttGridEditor.js"></script>
<script src="${PATH}/plugins/static/js/gantt/ganttMaster.js"></script>
</head>
...
.ganttButtonBar h1 {
	...
	<div id="gantEditorTemplates" style="display: none;">
		<div class="__template__" type="GANTBUTTONS">
			<div class="ganttButtonBar noprint">
				<h1 class="ganttTitle" title="gantt">
					<img src="${PATH}/plugins/static/css/gantt/res/MeritGantLogo.png"
						alt="gantt" align="absmiddle">
				</h1>
				<div class="buttons">
				...
				<table cellspacing="1" cellpadding="5" width="100%"
					...
					<tr>
						...
						<td colspan="3" valign="top"><label for="name"
							class="required">名称</label><br>
						<input type="text" name="name" id="name" class="formElements"
							autocomplete='off' maxlength=255 style='width: 100%' value=""
					...
					<tr class="dateRow">
						<td nowrap="">
							<div style="position: relative">
								...
								<br>
								<input type="text" name="start" id="start" size="8"
						...
						<td nowrap=""><label for="end">结束</label>&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<br>
						<input type="text" name="end" id="end" size="8"
				...
				<div class="modal-content">
						...
						<div class="modal-body-content">
							<div class="form-group">
								<form method="post" id="form1"
									action="/projectgant/importprojgant"
									enctype="multipart/form-data">
									<div class="form-inline" class="form-group">
										<label>选择项目进度数据文件(Excel)： <input type="file"
											class="form-control" name="gantsexcel" id="gantsexcel" />
										</label> <br />
									</div>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-primary"
							onclick="return importprojgants();">导入</button>
	...
	<script type="text/javascript">
		...
		$.JST.loadDecorator("ASSIGNMENT_ROW", function(assigTr, taskAssig) {
			...
			if (taskAssig.task.master.permissions.canWrite
				...
				assigTr.find(".delAssig").click(
						function() {
							var tr = $(this).closest("[assId]").fadeOut(200,
									function() {
										$(this).remove()
									});
						});
		...
		function createNewResource(el) {
			...
			var url = contextPath
					+ "/applications/teamwork/resource/resourceNew.jsp?CM=ADD&name="
					+ encodeURI(name);
			...
			openBlackPopup(url, 700, 320, function(response) {
				...
				if (response && response.resId && response.resName) {
					...
					row.find("[name=resourceId_txt]").val(response.resName)
							.focus().blur();
				}
	...
	<script type="text/javascript"
		src="${PATH}/plugins/static/js/bootstrap.min.js"></script>
