...
<head>
  ...
  <link rel=stylesheet href="${pageContext.request.contextPath}/plugins/static/css/gantt/platform.css" type="text/css">
  <link rel=stylesheet href="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/jquery/dateField/jquery.dateField.css" type="text/css">

  <link rel=stylesheet href="${pageContext.request.contextPath}/plugins/static/css/gantt/gantt.css" type="text/css">
  <link rel=stylesheet href="${pageContext.request.contextPath}/plugins/static/css/gantt/ganttPrint.css" type="text/css" media="print">
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/plugins/static/css/bootstrap.min.css"/>

  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/jquery.min.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/jquery-ui.min.js"></script>

  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/jquery/jquery.timers.js"></script>

  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/utilities.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/forms.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/date.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/dialogs.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/layout.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/i18nJs.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/jquery/dateField/jquery.dateField.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/jquery/JST/jquery.JST.js"></script>

  <script type="text/javascript" src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/jquery/svg/jquery.svg.min.js"></script>
  <script type="text/javascript" src="${pageContext.request.contextPath}/plugins/static/js/gantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>

  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/ganttUtilities.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/ganttTask.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/ganttDrawerSVG.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/ganttGridEditor.js"></script>
  <script src="${pageContext.request.contextPath}/plugins/static/js/gantt/ganttMaster.js"></script>
</head>
