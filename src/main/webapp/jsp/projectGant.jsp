...
%>
  ...
  <link rel=stylesheet href="${PATH}/plugins/static/css/gantt/platform.css" type="text/css">
  <link rel=stylesheet href="${PATH}/plugins/static/js/gantt/libs/jquery/dateField/jquery.dateField.css" type="text/css">

  <link rel=stylesheet href="${PATH}/plugins/static/css/gantt/gantt.css" type="text/css">
  <link rel=stylesheet href="${PATH}/plugins/static/css/gantt/ganttPrint.css" type="text/css" media="print">
  ...
  <script src="${PATH}/plugins/static/js/gantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
  <script src="${PATH}/plugins/static/js/gantt/libs/jquery/jquery.timers.js"></script>
  ...
  <script src="${PATH}/plugins/static/js/gantt/libs/jquery/dateField/jquery.dateField.js"></script>
  <script src="${PATH}/plugins/static/js/gantt/libs/jquery/JST/jquery.JST.js"></script>

  <script type="text/javascript" src="${PATH}/plugins/static/js/gantt/libs/jquery/svg/jquery.svg.min.js"></script>
  <script type="text/javascript" src="${PATH}/plugins/static/js/gantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>
...
<body style="background-color: #fff;">
  ...
  */
  ...
  <script src="${PATH}/plugins/static/js/jquery.form.js"></script>
  <script type="text/javascript">
