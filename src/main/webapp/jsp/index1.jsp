...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/plugins/bootstrap/css/flex.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/plugins/bootstrap/css/less.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/plugins/static/css/bootstrap-treeview.css" />
<script
	src="${pageContext.request.contextPath}/plugins/bootstrap/js/jquery.min.js"
	type="text/javascript" charset="utf-8"></script>
<script
	src="${pageContext.request.contextPath}/plugins/bootstrap/js/jquery-1.9.1.min.js"
	type="text/javascript" charset="utf-8"></script>
<script
	src="${pageContext.request.contextPath}/plugins/bootstrap/js/bootstrap.min.js"
	type="text/javascript" charset="utf-8"></script>
<script
	src="${pageContext.request.contextPath}/plugins/static/js/bootstrap-treeview.js"
	type="text/javascript" charset="utf-8"></script>
<style type="text/css">
...
<body>
	<div id="box" class="flex flex-v">
		<div id="head">
			<img src="${pageContext.request.contextPath}/plugins/img/logo.png"
				height="80%" style="margin: 8px">单击这个logo收回菜单
		</div>
		<div class="flex-1 flex">
			<div id="sidebar" data-toggle='show'>
				...
				<!-- 	<li data-src='page1.html' class="bg-primary">新建工程<span class="glyphicon glyphicon-pencil" ></span></li>
					...
					<li data-src='page1.jsp' class="bg-primary">新建工程<span
						class="glyphicon glyphicon-th-list"></span></li> -->
					<li data-src='page8.jsp'>在施工地<span
						class="glyphicon glyphicon-cog"></span></li>
					<li data-src='page9.jsp'>查看详情<span
						class="glyphicon glyphicon-cog"></span></li>
					<li data-src='projectGant.jsp'>查看详情2<span
						class="glyphicon glyphicon-cog"></span></li>
					<li data-src='basestage.jsp'>阶段基础表<span
						class="glyphicon glyphicon-cog"></span></li>
				</ul>
			</div>
