...
%>
  ...
  <link rel="stylesheet" type="text/css" href="${PATH}/plugins/static/css/jquery.mCustomScrollbar.min.css">
  ...
  <link rel="stylesheet" type="text/css" href="${PATH}/plugins/static/css/custom.css">
...
<!--     <div class="container-fluid">  -->
      <iframe src="basestage.jsp" name='main' frameborder="0"  width="100%" height="100%" scrolling="no" marginheight="0" marginwidth="0" id="iframepage" onload="this.height=100%" ></iframe>
<!--     </div> -->
